...
// Vicky Studio
// Agar menjadi top menu ganti 'add_ theme_ page' menjadi 'add_ menu_ page'
/* Add a subpage called "Theme Options" to the appearance menu. */

function optionsframework_add_page() {
	
	$menu = optionsframework_menu_settings();
	$of_page = add_menu_page( 'Template.my.id Panel', 'Template.my.id', 'edit_theme_options', 'options-framework', 'optionsframework_page', '', 66 );
...
function optionsframework_load_scripts( $hook ) {
	...
	// Vicky Studio
	// Agar bekerja sebagai top menu ganti 'appearance_page_' menjadi 'toplevel_page_'
	// Juga lakukan hal yang sama pada file 'options-media-uploader.php'
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear', 'tm_myid_text'),
			'defaultString' => __( 'Default', 'tm_myid_text'),
			'pick' => __( 'Select Color', 'tm_myid_text')
		);
...
function optionsframework_page() {
	settings_errors(); ?>
	<div class="tm_panel_name">Template.my.id Panel</div>
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				...
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Reset All Settings', 'optionsframework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'optionsframework' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->

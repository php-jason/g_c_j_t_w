<?php
/*
Plugin Name: TM Headline White (Sidebar)
Plugin URI:
Description: This widget for display headline post (White or Normal) in sidebar (center area and right area).
...
class TM_Category_Widget extends WP_Widget {

	// constructor widget class and description	
	function __construct() {
    	$widget_ops = array(
			'classname'   => 'widget_tm_category_thumbs', 
			'description' => 'This widget for display headline post (White or Normal) in sidebar (center area and right area).'
		);
    	parent::__construct('tmmyid_category_thumbs', 'TM Headline White (Sidebar)', $widget_ops);
	}
...
?>
	...
	function widget($args, $instance) {
			...
			echo "<div class='tm_catsidebar_thumbs'>";
		...
		?>
			...
			<!--<edit>-->
			<div class="tm_catsidebar_box tm-post-<?php the_ID(); ?>">		
...
function tm_tcatw_register_widgets() {
	register_widget( 'TM_Category_Widget' );
}

add_action( 'widgets_init', 'tm_tcatw_register_widgets' );
?>

<?php
/*
Plugin Name: TM Headline Blue (Sidebar)
Plugin URI:
Description: This widget for display headline post (Blue) in sidebar (center area and right area).
...
class TM_Headline_Widget extends WP_Widget {

	// constructor widget class and description	
	function __construct() {
    	$widget_ops = array(
			'classname'   => 'widget_tm_headline', 
			'description' => 'This widget for display headline post (Blue) in sidebar (center area and right area).'
		);
    	parent::__construct('tmmyid_headline_thumbs', 'TM Headline Blue (Sidebar)', $widget_ops);
	}
...
?>
	...
	function widget($args, $instance) {
			...
			echo "<div class='tm_sidebar_headline'>";
		...
		?>
			...
			<!--<edit>-->
			<div class="tm_sidebar_headline_box tm-post-<?php the_ID(); ?>">
...
function tm_bhdw_register_widgets() {
	register_widget( 'TM_Headline_Widget' );
}

add_action( 'widgets_init', 'tm_bhdw_register_widgets' );
?>

<?php
/*
Plugin Name: TM Grid 4 Box (Footer)
Plugin URI:
Description: This widget for display 4 grid box with thumbnail in footer or header area.
...
class TM_Footer_4_Box_Widget extends WP_Widget {

	// constructor widget class and description	
	function __construct() {
    	$widget_ops = array(
			'classname'   => 'widget_tm_4_box_thumbs', 
			'description' => 'This widget for display 4 grid box with thumbnail in footer or header area.'
		);
    	parent::__construct('tmmyid_4_box_thumbs', 'TM Grid 4 Box (Footer)', $widget_ops);
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Total Posts (Max 16 Posts):', 'tm_myid_text'); ?></label>
	...
	function widget($args, $instance) {
		...
		?>
			...
			<!--<edit>-->
			<div class="tm_fourbox_allitem tm-post-<?php the_ID(); ?>">	
...
function tm_f4bw_register_widgets() {
	register_widget( 'TM_Footer_4_Box_Widget' );
}

add_action( 'widgets_init', 'tm_f4bw_register_widgets' );
?>

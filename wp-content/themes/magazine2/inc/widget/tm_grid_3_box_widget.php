<?php
/*
Plugin Name: TM Grid 3 Box (Home Left)
Plugin URI:
Description: This widget for display grid 3 box post with thumbnail in left area.
...
class TM_Grid_Three_Box_Widget extends WP_Widget {

	// constructor widget class and description	
	function __construct() {
    	$widget_ops = array(
			'classname'   => 'widget_tm_three_box_thumbs', 
			'description' => 'This widget for display grid 3 box post with thumbnail in Homepage left area.'
		);
    	parent::__construct('tmmyid_three_box_thumbs', 'TM Grid 3 Box (Home Left)', $widget_ops);
	}
	...
	function form( $instance ) {
		...
		$title = isset($instance['title']) ? esc_attr($instance['title']) : 'Your Title';
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Total Posts (Max 15 Posts):', 'tm_myid_text'); ?></label>
	...
	function widget($args, $instance) {
		...
		?>
			...
			<!--<edit>-->
			<div class="tm_bricknews_2_box tm-post-<?php the_ID(); ?>">
			
				<div class="tm_bricknews_2_images">
				...
				<div class="tm_bricknews_2_titles">
					<a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>">
...
function tm_gthreebw_register_widgets() {
	register_widget( 'TM_Grid_Three_Box_Widget' );
}

add_action( 'widgets_init', 'tm_gthreebw_register_widgets' );
?>
